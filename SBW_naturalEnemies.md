---
title: "SBW_naturalEnemies Manual"
...
editor_options:
  ...
  bibliography: citations/references_SBW_naturalEnemies.bib
link-citations: true
always_allow_html: true
---

# SBW_naturalEnemies Module

<!-- the following are text references used in captions for LaTeX compatibility -->
(ref:SBW-naturalEnemies) *SBW_naturalEnemies*
...
If `sourceURL` is specified, `downloadData("SBW_naturalEnemies", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")` may be sufficient.
Table \@ref(tab:moduleInputs-SBW-naturalEnemies) shows the full list of module inputs.

<table class="table" style="color: black; margin-left: auto; margin-right: auto;">
<caption>(\#tab:moduleInputs-SBW-naturalEnemies)(\#tab:moduleInputs-SBW-naturalEnemies)List of (ref:SBW-naturalEnemies) input objects and their description.</caption>
 <thead>
  <tr>
...
Provide a summary of user-visible parameters (Table \@ref(tab:moduleParams-SBW-naturalEnemies))


<table class="table" style="color: black; margin-left: auto; margin-right: auto;">
<caption>(\#tab:moduleParams-SBW-naturalEnemies)(\#tab:moduleParams-SBW-naturalEnemies)List of (ref:SBW-naturalEnemies) parameters and their description.</caption>
 <thead>
  <tr>
...
Description of the module outputs (Table \@ref(tab:moduleOutputs-SBW-naturalEnemies)).

<table class="table" style="color: black; margin-left: auto; margin-right: auto;">
<caption>(\#tab:moduleOutputs-SBW-naturalEnemies)(\#tab:moduleOutputs-SBW-naturalEnemies)List of (ref:SBW-naturalEnemies) outputs and their description.</caption>
 <thead>
  <tr>
   <th style="text-align:left;"> objectName </th>
   <th style="text-align:left;"> objectClass </th>
